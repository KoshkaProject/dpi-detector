...
async def main():
    ...
    console.print(
        "[dim]Тестирование обрыва соединения при передаче данных (На самом деле 4-60KB блокировка)[/dim]\n"
    )
    ...
    legend = [
        ...
        ("TCP16-20", "Соединение оборвано после 4-60KB (блок передачи данных DPI)"),
